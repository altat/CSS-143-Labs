...
public class ShapesPictureDriver {
	...
	//precondition: assumes {Square, Circle, Picture} all exist in the same
	// working directory
	//postcondition: 2 Squares, 2 Circles, and 1 Picture are constructed and
    // manipulated, then reclaimed once main exits
	public static void main(String[] args) {
        ...
        pic.addSquare(firstSquare);
        pic.addSquare(secondSquare);
        pic.addCircle(firstCircle);
        pic.addCircle(secondCircle);
