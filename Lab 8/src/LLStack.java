...
//The "addToStart" method is the cause for the LIFO structure because it adds to
//the beginning, thus pushing the previous start down the list by one
  public class LLStack {
    ...
    // thus no setter or getters are needed
      private class Node {
       ...
       // Removes the head node and returns the data Object being deleted.
