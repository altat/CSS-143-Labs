	...
	public class PolyDemoPanel extends JPanel {		
		...
		public Shape getRandShape() {
			...
			switch( ( int )(Math.random() * 4) ) {
				case 0: 	retVal = new Triforce( x,y,getRandInt() );//new
                    // Square( x, y, getRandInt(), getRandInt() );
							break;
				case 1: 	retVal = new Circle( x,y,getRandInt() );//Cube( x, y,
					// getRandInt(), getRandInt(), getRandInt() );
							break;
				case 2: 	retVal = new Triforce( x,y,getRandInt() );
							break;
				case 3: 	retVal = new Spray( x,y);////new
                    // Cylinder( x,y, getRandInt(), getRandInt() );
							break;				
			}
